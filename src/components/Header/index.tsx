    ...
    return (
        <>
            <header className='min-w-full text-gray-600'>
                <div className='w-full flex flex-col flex-wrap items-center px-5 py-3 shadow-md md:flex-row'>
                    <div
                        className='mb-4 flex items-center font-medium text-gray-900 md:mb-0'
                    >
                        <span className='text-xl'>Bloodline Analysis</span>
                    </div>
                    ...
                    <div className='hidden items-center rounded-md shadow-sm ring-1 ring-gray-900/5 lg:flex'>
                        <HeaderButton
...
const Setting = ({ open, setOpen, children }: SettingProps) => {
    return (
        ...
        >
            <button
                className={clsx(
                    'dark:shadow-highlight/4 block shadow-sm ring-1 ring-gray-900/5 hover:bg-gray-50',
    ...
    return (
        ...
        >
            ...
            <svg
                width={width}
                height={height}
                viewBox={`${(width - naturalWidth) / -2} ${(height - naturalHeight) / -2
                    } ${width} ${height}`}
                strokeWidth='2'
                strokeLinecap='round'
